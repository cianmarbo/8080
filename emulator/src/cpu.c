...
// Scratch buffer used by dump_registers() to lay out register bytes for printing.
static uint8_t* register_array = NULL;
...
static void disassemble_instruction(uint8_t* instruction) {
